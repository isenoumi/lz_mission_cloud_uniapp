  ...
  <view>
    <view>
      <view class="img">
        ...
        <image class="imgs" src="http://cdn.cestech.com.cn/BkpKnowledge/img/a3c2bf883a834fecaafeef686e245890.jpg"
      ...
      <view class="box">
        <view class="title">
          ...
          <view class="txt"><text>已做题：</text><text class="order">{{numberAnswers}}道</text></view>
        </view>
        <view class="mian">
          <view class="name">答题规则提示：</view>
          <view class="text">
            <view>1、每开始进行答题时，随机获取5道题进行答题，当全部答题完成时，系统则给与积分作为答题竞赛奖励。</view>
            <view class="gz">2、中途答题出错时，可选择重新开始以及继续答题，如果选择继续答题时，当题答完题时则没有对应的积分奖励。</view>
            <view>3、重新答题时，可重新随机获取5道题给到用户进行答题，这时如果全部答对，可获得对应的积分奖励。</view>
          </view>
