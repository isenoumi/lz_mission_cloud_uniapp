<template>
  <view>
    <view class="u-nav">
      <navbar :safeAreaInsetTop="true" height="55" placeholder :allTitle="false"
			imageSrc="https://oms.cestech.com.cn/BkpKnowledge/img/d695ce4a52d44b84a6d23facfa6cd0d4/路径 8959.png"
			leftIconColor="#fff" autoBack>
        <view class="u-nav-slot" slot="center">
          <u--text text="商品详情" color="#fff"></u--text>
        </view>
      </navbar>
    </view>
    <view class="u-demo-block" style="position: relative;">
        ...
        <view slot="indicator" class="indicator">
          <view class="indicator__dot" v-for="(item, index) in list5" :key="index"
			...
			<view class="logo">
				<image
				class="img"
					src="https://oms.cestech.com.cn/BkpKnowledge/img/d26ee05759d648fe985a21ebaf707724/微信图片_20240517133915.jpg"
				mode="scaleToFill"
					/>
				
				<view class="text">本商品由成都银行赞助</view>
			</view>
    </view>
