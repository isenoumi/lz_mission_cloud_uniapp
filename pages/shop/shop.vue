		...
		<view class="body">
			<view class="top">
				<view class="">
					...
					<view class="integralRank" @click="integral">
						明细/记录/规则>
					</view>
				</view>

				<view class="img">
					<image src="http://cdn.cestech.com.cn/BkpKnowledge/img/063ea2bc56da44adbc200412a0ffd649.png"
						mode="widthFix">
					</image>
				</view>
			...
			<view class="search">
				<u-search placeholder="搜索您想要的商品" v-model="keyword" :showAction="false" disabled
				...
				<view class="main">
					...
					<scroll-view scroll-y="true" class="rightcontent">
						...
						<view class="cont-item "
							...
							<view v-for="items in productList.list" style="margin-bottom: 20rpx;">
								<view style="width: 188rpx;text-align: center;" @click="shop_details(items)"
									class="itemss">
									<view>
										<image :src="items.pic" class="more-pic" mode="scaleToFill"
