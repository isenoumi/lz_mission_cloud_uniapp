<template>
  <view>
    ...
    <view class="conetent-body">
      <u-swiper :list="swiperList" keyName="url" previousMargin="30" nextMargin="30" :autoplay="false" circular
        radius="5" @click="swiperClick" bgColor="#ffffff" @change="swiperChange">
      ...
      <u-grid :border="false" col="4">
        <u-grid-item v-for="(listItem,listIndex) in menuLists" :key="listIndex"
      ...
      <view class="u-flex  u-p kc">
        ...
        <view class="u-flex-1 u-m-l kc-right u-flex-col">
          ...
          <view class="u-flex-col u-flex-1 kc-right__item" v-for="(item,index) in list1" :key="item.id"
            ...
            <view class="z-card">
              ...
              <view class="z-card__info z-card__info-ss">
                <view class="z-card__info--left">
                  <u--text size="13" prefixIcon="/static/assets/home/hot.png" lines="1" type="info" :iconStyle='{
                                        "margin-right":"5px" }' :text="item.type"></u--text>
                </view>
      ...
      <view class="z-card2" v-for="(item,index) in list2" :key="item.id" @click="goknowledgedetail(item)">
        <view class="z-card__content">
          <view class="z-card__info">
            ...
            <view class="z-card__info--desc">
              <view class="z-card__info--desc--left">
                <u--text size="13" lines="1" type="info" :text="item.type"></u--text>
              </view>
              <view class="integral">
          ...
          <view class="z-card__image">
            <u--image :showLoading="true" :src="item.url" mode="aspectFit" width="100%" height="80px" radius="8">
            </u--image>
          </view>
        </view>
      </view>
    ...
    <view class="tankuang" v-if="showTankuang">
      <image src="http://cdn.cestech.com.cn/BkpKnowledge/img/88939b8e22e5456d8720d83e684be8c1.png"
        style="height: 940rpx;">
      </image>
      <view class="text">
