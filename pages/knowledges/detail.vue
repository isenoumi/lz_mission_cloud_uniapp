  ...
  <view class="container">
    ...
    <view
      ...
      <view class="u-m-t u-m-b">
        <u--text type="info" size="13" :text="detail.create_time"> </u--text>
      </view>

      <u-line></u-line>
      <!-- <view
        style="margin-top: 30rpx"
        class="titleBox text-xl text-black text-bold"
        >{{ detail.title + '相关资料如下' || '' }}
      </view> -->
      <view class="u-m-t">
      ...
      <view class="u-m-t u-m-b" v-for="item in list">
        <!-- <video
          v-if="item.name && item.name.endsWith('mp4')"
          :src="item.value"
          muted
          autoplay
          loop
        ...
        <u--text
          v-else
          @click="downloadFun(item.value, item.name)"
          type="primary"
          size="18"
          :text="item.name">
        </u--text>
